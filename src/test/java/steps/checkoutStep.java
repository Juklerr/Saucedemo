...
public class checkoutStep {
    ...
    @Before
    public void setup(){
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\leona\\OneDrive\\Documentos\\Chrome Driver\\chromedriver.exe");
    ...
    public void deve_se_ver(String tipoCenario) {
        ...
        if (tipoCenario.equals("valido")) {
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/div/div/div[1]/div[2]/span")));
            String valido = driver.findElement(By.xpath("/html/body/div/div/div/div[1]/div[2]/span")).getText();
            Assert.assertEquals("CHECKOUT: OVERVIEW", valido);
        }

        if (tipoCenario.equals("name vazio")) {
            String nameVazio = driver.findElement(By.xpath("/html/body/div/div/div/div[2]/div/form/div[1]/div[4]/h3")).getText();
            Assert.assertEquals("Error: First Name is required", nameVazio);
        }
 ...
 // Selenium 3.141.59;  JUnit  4.12;  Cucumber Java 6.10.3;  Cucumber Junit 6.10.3;